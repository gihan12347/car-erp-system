...
public class PreparationProgressService {
    ...
    public boolean isEligible(Vehicle vehicle) {
        ...
        return customsProgressService.progressFor(vehicle).isClearanceComplete();
    }
    ...
    public void syncVehicleStage(String chassisNo) {
        ...
        if (current == VehicleStage.READY && customsProgressService.progressFor(vehicle).isClearanceComplete()) {
