...
final class AuctionSheetEnglish {
    ...
    static boolean containsJapanese(String value) {
        return value != null && JAPANESE.matcher(value).find();
    }

    static String translateLine(String line, JapaneseTextTranslator translator) {
        return translateSheet(line, translator);
    }

    static String translateSheet(String text, JapaneseTextTranslator translator) {
        if (text == null || translator == null || !containsJapanese(text)) {
            return text;
        }
    ...
    static String maskSheetTokens(String line, List<String> tokens) {
    ...
    static String restoreSheetTokens(String translated, List<String> tokens) {
        if (translated == null) {
            return null;
        }
    ...
    static String convert(String value, JapaneseTextTranslator translator) {
        if (value == null) {
            return null;
        }
