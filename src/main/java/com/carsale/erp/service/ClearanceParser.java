...
public class ClearanceParser {
    ...
    public AuctionParseResult parsePage1(String text) {
        ...
        result.put("jevicModel", extractJevicScalar(normalized, "Model", "Date of Inspection", "Location"));
        result.put("jevicInspectionDate", extractJevicDate(normalized, "Date\\s+of\\s+Inspection", "Location", "Certificate"));
        result.put("jevicLocation", extractJevicLocation(normalized));
        result.put("jevicCertificateNo", extractJevicCertificateNo(normalized));
        result.put("jevicIssueDate", extractJevicIssueDate(normalized));
        result.put("jevicCurrentOdometer", extractJevicOdometer(normalized));
        ...
        finish(result, "JEVIC odometer certificate (page 1)");
        return result;
    }

    private String extractJevicChassis(String text) {
        String value = extractJevicScalar(text, "Chassis\\s*/\\s*VIN", "Make", "Model");
        if (value == null) {
    ...
    private String trimBeforeNextJevicLabel(String value, String... stopLabels) {
        ...
        String[] defaults = new String[] {
                "Make", "Model", "Date of Inspection", "Location", "Certificate No",
                "Date of Issue", "Current Odometer", "Auction Reading", "Dealer Reading",
    ...
    public AuctionParseResult parsePage2(String text) {
        ...
        result.put("blAwbNo", extractLabel(normalized, "BL / AWB", "BL/", "AWB"));
